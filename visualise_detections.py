...
model = '/home/leon/OWOD_new/output/runs_CODA/model_0004999.pth'
cfg_file = '/home/leon/OWOD_new/configs/CODA/train.yaml'
...
output_dir = 'results/'
files = os.listdir('/home/leon/detr/OW-DETR-main/data/coda_train/JPEGImages')

param_save_location = os.path.join('/home/leon/OWOD_new/output/runs_CODA/energy_dist_' + str(29) + '.pkl')
...
for file in files:
    if os.path.exists(output_dir+'output_' + file): continue
    im = cv2.imread("/home/leon/detr/OW-DETR-main/data/coda_train/JPEGImages/" + file)
    ...
    print(classes)
    # unknown
    if 80 in outputs["instances"].pred_classes:
        print("80 here",file)
    ...
    img = v.get_image()[:, :, ::-1]
    cv2.imwrite(output_dir+'output_' + file, img)
